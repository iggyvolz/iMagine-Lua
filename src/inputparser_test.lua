...
describe("InputParser",function()
  ...
  describe("with no person",function()
    describe("with action magine",function()
      describe("without args",function()
        local text,subject,action,params=inputParser("magine()")
        it("should return magine() as the first argument.",function()
          assert.are.same("magine()",text)
        end)
        it("should return tony as the second argument.",function()
          assert.are.same("tony",subject)
        end)
      ...
      describe("with parameter furok",function()
        local text,subject,action,params=inputParser("magine(furok)")
        it("should return magine(furok) as the first argument.",function()
          assert.are.same("magine(furok)",text)
        end)
        it("should return tony as the second argument.",function()
          assert.are.same("tony",subject)
        end)
      ...
      describe("with parameters furok and djarmander",function()
        local text,subject,action,params=inputParser("magine(furok,djarmander)")
        it("should return magine(furok,djarmander) as the first argument.",function()
          assert.are.same("magine(furok,djarmander)",text)
        end)
        it("should return tony as the second argument.",function()
          assert.are.same("tony",subject)
        end)
  ...
  describe("with person tony",function()
    describe("with action magine",function()
      describe("without args",function()
        local text,subject,action,params=inputParser("tony.magine()")
        it("should return tony.magine() as the first argument.",function()
          assert.are.same("tony.magine()",text)
        end)
        it("should return tony as the second argument.",function()
          assert.are.same("tony",subject)
        end)
      ...
      describe("with parameter furok",function()
        local text,subject,action,params=inputParser("tony.magine(furok)")
        it("should return tony.magine(furok) as the first argument.",function()
          assert.are.same("tony.magine(furok)",text)
        end)
        it("should return tony as the second argument.",function()
          assert.are.same("tony",subject)
        end)
      ...
      describe("with parameters furok and djarmander",function()
        local text,subject,action,params=inputParser("tony.magine(furok,djarmander)")
        it("should return tony.magine(furok,djarmander) as the first argument.",function()
          assert.are.same("tony.magine(furok,djarmander)",text)
        end)
        it("should return tony as the second argument.",function()
          assert.are.same("tony",subject)
        end)
  ...
  describe("with person edyn",function()
    describe("with action magine",function()
      describe("without args",function()
        local text,subject,action,params=inputParser("edyn.magine()")
        it("should return edyn.magine() as the first argument.",function()
          assert.are.same("edyn.magine()",text)
        end)
        it("should return edyn as the second argument.",function()
          assert.are.same("edyn",subject)
        end)
        it("should return magine as the third argument.",function()
          assert.are.same("magine",action)
        end)
      ...
      describe("with parameter ugger",function()
        local text,subject,action,params=inputParser("edyn.magine(ugger)")
        it("should return edyn.magine(ugger) as the first argument.",function()
          assert.are.same("edyn.magine(ugger)",text)
        end)
        it("should return edyn as the second argument.",function()
          assert.are.same("edyn",subject)
        end)
        ...
        it("should return {\"ugger\"} as the fourth argument.",function()
          assert.are.same(params,{"ugger"})
        end)
      end)
      describe("with parameters ugger and balamant",function()
        local text,subject,action,params=inputParser("edyn.magine(ugger,balamant)")
        it("should return edyn.magine(ugger,balamant) as the first argument.",function()
          assert.are.same("edyn.magine(ugger,balamant)",text)
        end)
        it("should return edyn as the second argument.",function()
          assert.are.same("edyn",subject)
        end)
        ...
        it("should return {\"ugger\",\"balamant\"} as the fourth argument.",function()
          assert.are.same(params,{"ugger","balamant"})
        end)
      end)
    end)
  end)
